...
const StudentDashboard = () => {
  ...
  // UPDATED: Progress function now handles 'Rejected' status
            ...
            {requests.length > 0 ? (
              requests.map((req) => (
                <div key={req._id} className="request-card student-card">
                  ...
                  {/* ADDED: This block shows the rejection reason if the status is 'Rejected' */}
                  ...
                  <div className="progress-container">
                    {/* UPDATED: The progress bar is now red for rejected status */}
                    <div 
